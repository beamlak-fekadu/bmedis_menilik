    ...
    <div className="space-y-8">
      ...
      <section aria-label="Store quick links">
        <div className="flex flex-wrap gap-2">
          ...
          <Link href="/notifications" className="inline-flex items-center gap-2 rounded-md border border-[var(--border-subtle)] px-3 py-1.5 text-sm text-[var(--text-muted)] hover:text-[var(--foreground)]">Logistics Notifications</Link>
