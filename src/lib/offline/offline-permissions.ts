...
const ROLE_OFFLINE_PERMISSIONS: Record<RoleName, OfflineRolePermission> = {
  developer: {
    ...
    notes: 'May inspect diagnostics, manage the local queue, and replay supported offline workflows.',
  },
  admin: {
    canInspectDiagnostics: true,
    canManageLocalQueue: true,
    ...
    notes: 'May review cached data and replay supported maintenance, PM, and calibration workflows. Final approvals remain online-only.',
  },
  bme_head: {
    canInspectDiagnostics: true,
    canManageLocalQueue: true,
    ...
    notes: 'May review cached data and replay supported maintenance, PM, and calibration workflows. Major approvals are not allowed offline.',
  },
  technician: {
    ...
    notes: 'Offline work focuses on cached/assigned execution and additive maintenance evidence. Final server facts are created only after replay validation.',
  },
  department_head: {
    canInspectDiagnostics: false,
    canManageLocalQueue: false,
