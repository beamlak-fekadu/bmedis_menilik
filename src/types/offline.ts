...
export const OFFLINE_ACTION_DEFINITIONS: Record<OfflineActionType, OfflineActionDefinition> = {
  ...
  'qr_scan.record': {
    actionType: 'qr_scan.record',
    label: 'Record offline QR scan',
    category: 'additive_safe',
    syncHandler: 'phase2',
  },
  'work_order.start': {
    actionType: 'work_order.start',
    label: 'Start work order after server validation',
    category: 'state_change_requires_validation',
    syncHandler: 'phase2',
  },
  'work_order.complete': {
    actionType: 'work_order.complete',
    label: 'Complete work order after server validation',
    category: 'state_change_requires_validation',
    syncHandler: 'phase2',
  },
  'work_order.start_intent': {
  ...
  'pm.complete': {
    ...
    label: 'Complete PM after server validation',
    category: 'state_change_requires_validation',
    syncHandler: 'phase2',
  },
  'calibration_result.create': {
    actionType: 'calibration_result.create',
    label: 'Record calibration result after server validation',
    category: 'state_change_requires_validation',
    syncHandler: 'phase2',
  },
  'procurement.approve': {
