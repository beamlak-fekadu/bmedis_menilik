...
INSERT INTO profiles (id, full_name, email, phone, department_id, job_title, is_active) VALUES
    ...
    -- Legacy Hanna is retained only for historical FK references; the active demo technician is technician@bmedis-menelik.local.
    ('a3000001-0000-0000-0000-000000000002', 'Hanna Gebremedhin', 'removed.hanna.legacy@menelikii.gov.et', '+251-91-345-6789', NULL, 'Legacy Biomedical Technician', false),
