...
-- Creates roles and profiles for demo users at St. Peter's Specialized Hospital.
-- NOTE: In production, auth.users entries are created via Supabase Auth.
-- For seed purposes, we insert profiles directly and link them later after auth signup.
...
-- =============================================================================
-- PROFILES (15 users)
-- user_id is NULL until linked via Supabase Auth; we use profile id for references
-- =============================================================================
INSERT INTO profiles (id, full_name, email, phone, department_id, job_title, is_active) VALUES
    -- Admin (Biomedical Head)
    ('a3000001-0000-0000-0000-000000000001', 'Dr. Ermias Tadesse', 'ermias.tadesse@stpeters.gov.et', '+251-91-234-5678', NULL, 'Head of Biomedical Engineering', true),
    -- Technicians
    ('a3000001-0000-0000-0000-000000000002', 'Hanna Gebremedhin', 'hanna.g@stpeters.gov.et', '+251-91-345-6789', NULL, 'Senior Biomedical Technician', true),
    ('a3000001-0000-0000-0000-000000000003', 'Solomon Bekele', 'solomon.b@stpeters.gov.et', '+251-91-456-7890', NULL, 'Biomedical Technician', true),
    ('a3000001-0000-0000-0000-000000000004', 'Meron Alemu', 'meron.a@stpeters.gov.et', '+251-91-567-8901', NULL, 'Biomedical Technician', true),
    -- Department Users (one per department)
    ('a3000001-0000-0000-0000-000000000005', 'Sr. Tigist Worku', 'tigist.w@stpeters.gov.et', '+251-91-678-9012', 'd0000001-0000-0000-0000-000000000001', 'ICU Head Nurse', true),
    ('a3000001-0000-0000-0000-000000000006', 'Dr. Yonas Abera', 'yonas.a@stpeters.gov.et', '+251-91-789-0123', 'd0000001-0000-0000-0000-000000000002', 'Chief Surgeon', true),
    ('a3000001-0000-0000-0000-000000000007', 'Sr. Bethlehem Desta', 'bethlehem.d@stpeters.gov.et', '+251-91-890-1234', 'd0000001-0000-0000-0000-000000000003', 'Emergency Department Lead', true),
    ('a3000001-0000-0000-0000-000000000008', 'Dr. Fitsum Haile', 'fitsum.h@stpeters.gov.et', '+251-91-901-2345', 'd0000001-0000-0000-0000-000000000004', 'Radiologist', true),
    ('a3000001-0000-0000-0000-000000000009', 'Ato Dawit Mekonnen', 'dawit.m@stpeters.gov.et', '+251-91-012-3456', 'd0000001-0000-0000-0000-000000000005', 'Lab Manager', true),
    ('a3000001-0000-0000-0000-000000000010', 'W/ro Selamawit Girma', 'selamawit.g@stpeters.gov.et', '+251-91-123-4567', 'd0000001-0000-0000-0000-000000000006', 'Chief Pharmacist', true),
    ('a3000001-0000-0000-0000-000000000011', 'Sr. Rahel Mengistu', 'rahel.m@stpeters.gov.et', '+251-91-234-5670', 'd0000001-0000-0000-0000-000000000007', 'Ward Charge Nurse', true),
    ('a3000001-0000-0000-0000-000000000012', 'Dr. Abel Habtamu', 'abel.h@stpeters.gov.et', '+251-91-345-6780', 'd0000001-0000-0000-0000-000000000008', 'OPD Physician', true),
    -- Store User
    ('a3000001-0000-0000-0000-000000000013', 'Ato Biniam Teshome', 'biniam.t@stpeters.gov.et', '+251-91-456-7801', NULL, 'Medical Equipment Store Officer', true),
    -- Management Viewers
    ('a3000001-0000-0000-0000-000000000014', 'Dr. Amanuel Kifle', 'amanuel.k@stpeters.gov.et', '+251-91-567-8012', NULL, 'Medical Director', true),
    ('a3000001-0000-0000-0000-000000000015', 'W/ro Meseret Yilma', 'meseret.y@stpeters.gov.et', '+251-91-678-9023', NULL, 'Hospital Administrator', true);
